...
public class adapteraklat4 extends RecyclerView.Adapter<adapteraklat4.viewholder>{
    Context context;
    ...
    public adapteraklat4(Context con, ArrayList<foodtypes> myliste)
    {
        this.context=con;
...
*/
    ...
    @NonNull
    @Override
    public adapteraklat4.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View myview= LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.typerow,parent,false);
        return new adapteraklat4.viewholder(myview);
    }

    @Override
    public void onBindViewHolder(@NonNull final adapteraklat4.viewholder holder, int position) {
        GlideApp
                .with(context)
